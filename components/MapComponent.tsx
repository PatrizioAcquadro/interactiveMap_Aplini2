...
const MapComponent: React.FC = () => {
  ...
  const restrictedAreaCoords: L.LatLngExpression[] = [
    // Change type to L.LatLngExpression[]
    // Points from Set 1 (your "New coordinates", excluding its duplicate closing point)
    [45.561227, 8.061355],
    [45.56027, 8.058474],
    [45.5602363, 8.0583527],
    [45.5597892, 8.0568911],
    [45.559774, 8.056843],
    [45.55719, 8.048582],
    [45.560405, 8.047466],
    [45.560781, 8.048131],
    ...
    // Points from Set 2 (your original "CODE" coordinates, excluding its duplicate closing point)
    [45.57059, 8.055551],
    [45.570862, 8.054496],
    [45.571, 8.053506],
    [45.570654, 8.052358],
    ...
    [45.563556, 8.059868],
    [45.565901, 8.058418],
    // Leaflet will automatically close this single polygon by connecting the last point
    // back to the first point.
  ];
  // How you would use this with Leaflet:
  // const polygonLayer = L.polygon(restrictedAreaCoords, { color: 'red' }).addTo(map);

  // This will create a single Leaflet layer (polygonLayer) that has two
  // separate filled areas on the map, each with its own border.
