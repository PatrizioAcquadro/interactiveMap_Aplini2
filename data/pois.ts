...
export const poiData: POI[] = [
  ...
  },
  {
    ...
    details:
      "Lo storico marchio De Ruvo Macelleria propone le sue specialità biellesi all'Adunata. Troverete panini farciti come il 'Biellese', 'La Somarina', 'Bresaola' (di nostra produzione macelleria), 'Prosciutto cotto' Rovagnati e 'Coppa' (di nostra produzione macelleria). Offrono anche polenta concia, formaggi Botalla, salumi di produzione propria, focaccia, pizza e una selezione di bevande, inclusa birra Menabrea, liquori alpini e vini pregiati delle Tenute Sella, tra cui Barbera e Prosecco. Un assaggio autentico del territorio.", // Updated
    details_en:
      "The historic De Ruvo Macelleria brand offers its Biellese specialties at the Adunata. You'll find stuffed sandwiches like 'Biellese', 'La Somarina', 'Bresaola' (from their own butcher shop), Rovagnati 'Cooked Ham', and 'Coppa' (from their own butcher shop). They also offer polenta concia, Botalla cheeses, house-cured meats, focaccia, pizza, and a selection of drinks, including Menabrea beer, alpine liqueurs, and fine wines from Tenute Sella, such as Barbera and Prosecco. An authentic taste of the region.", // Updated
    details_es:
      "La histórica marca De Ruvo Macelleria ofrece sus especialidades de Biella en la Adunata. Encontrará bocadillos rellenos como el 'Biellese', 'La Somarina', 'Bresaola' (de su propia carnicería), 'Jamón Cocido' Rovagnati y 'Coppa' (de su propia carnicería). También ofrecen polenta concia, quesos Botalla, embutidos de producción propia, focaccia, pizza y una selección de bebidas, incluyendo cerveza Menabrea, licores alpinos y vinos finos de Tenute Sella, como Barbera y Prosecco. Un auténtico sabor de la región.", // Updated
    details_fr:
      "La marque historique De Ruvo Macelleria propose ses spécialités de Biella à l'Adunata. Vous trouverez des sandwichs garnis comme le 'Biellese', 'La Somarina', la 'Bresaola' (de leur propre boucherie), le 'Jambon Cuit' Rovagnati et la 'Coppa' (de leur propre boucherie). Ils proposent également de la polenta concia, des fromages Botalla, des charcuteries maison, de la focaccia, des pizzas et une sélection de boissons, y compris de la bière Menabrea, des liqueurs alpines et des vins fins des Tenute Sella, tels que le Barbera et le Prosecco. Un goût authentique de la région.", // Updated
    details_de:
      "Die historische Marke De Ruvo Macelleria bietet ihre Bielleser Spezialitäten auf der Adunata an. Sie finden gefüllte Sandwiches wie 'Biellese', 'La Somarina', 'Bresaola' (aus eigener Metzgerei), 'Kochschinken' Rovagnati und 'Coppa' (aus eigener Metzgerei). Sie bieten auch Polenta Concia, Botalla-Käse, hausgemachte Wurstwaren, Focaccia, Pizza und eine Auswahl an Getränken, darunter Menabrea-Bier, Alpenliköre und erlesene Weine von Tenute Sella, wie Barbera und Prosecco. Ein authentischer Geschmack der Region.", // Updated
  ...
  {
    id: 230, // New unique ID
    name: "Klasik",
    name_en: "Klasik (Bar & Food)",
    name_es: "Klasik (Bar y Comida)",
    name_fr: "Klasik (Bar & Restauration)",
    name_de: "Klasik (Bar & Speisen)",
    type: "restaurant", // Categorized as restaurant due to "Serve cibo al bar"
    coordinates: [45.569295, 8.050237],
    googleRating: 4.5,
    googleReviewCount: 15,
    address: "Via C. Cavour, 3C, 13900 Biella BI",
    phone: "0152470435",
    website: "https://www.facebook.com/profile.php?id=61558396388521#", // Note: Hash at the end might be unintentional from copy-paste
    shortDescription:
      "Klasik a Biella: bar con cibo, happy hour e cani ammessi. Aperto tutti i giorni.",
    shortDescription_en:
      "Klasik in Biella: bar with food, happy hour, and dogs allowed. Open daily.",
    shortDescription_es:
      "Klasik en Biella: bar con comida, happy hour y perros admitidos. Abierto todos los días.",
    shortDescription_fr:
      "Klasik à Biella : bar avec restauration, happy hour et chiens admis. Ouvert tous les jours.",
    shortDescription_de:
      "Klasik in Biella: Bar mit Speisen, Happy Hour und Hunde erlaubt. Täglich geöffnet.",
    details:
      "Klasik, situato in Via Cavour a Biella, è un accogliente bar che serve anche cibo, rendendolo perfetto per un pasto informale o uno spuntino. Particolarmente noto per i suoi drink durante l'happy hour. L'ambiente è pet-friendly, quindi i cani sono i benvenuti. Aperto tutti i giorni con orario continuato dalla mattina fino a sera, offrendo una comoda opzione per i visitatori dell'Adunata.",
    details_en:
      "Klasik, located on Via Cavour in Biella, is a cozy bar that also serves food, making it perfect for an informal meal or a snack. Particularly known for its happy hour drinks. The environment is pet-friendly, so dogs are welcome. Open daily with continuous hours from morning until evening, offering a convenient option for Adunata visitors.",
    details_es:
      "Klasik, ubicado en Via Cavour en Biella, es un bar acogedor que también sirve comida, lo que lo hace perfecto para una comida informal o un tentempié. Especialmente conocido por sus bebidas de happy hour. El ambiente es apto para mascotas, por lo que los perros son bienvenidos. Abierto todos los días con horario continuado desde la mañana hasta la noche, ofreciendo una opción conveniente para los visitantes de la Adunata.",
    details_fr:
      "Klasik, situé Via Cavour à Biella, est un bar confortable qui sert également de la nourriture, ce qui le rend parfait pour un repas informel ou une collation. Particulièrement réputé pour ses boissons happy hour. L'environnement est adapté aux animaux de compagnie, les chiens sont donc les bienvenus. Ouvert tous les jours en continu du matin au soir, offrant une option pratique pour les visiteurs de l'Adunata.",
    details_de:
      "Das Klasik in der Via Cavour in Biella ist eine gemütliche Bar, die auch Speisen serviert und sich somit perfekt für eine informelle Mahlzeit oder einen Snack eignet. Besonders bekannt für seine Happy-Hour-Getränke. Die Umgebung ist haustierfreundlich, Hunde sind also willkommen. Täglich durchgehend von morgens bis abends geöffnet und bietet eine praktische Option für Adunata-Besucher.",
    images: ["/images/klasik.jpeg"], // Suggested image path
    openingHours: `Lun-Gio, Dom: 06:00-20:00\nVen-Sab: 06:00-21:00`,
    openingHours_en: `Mon-Thu, Sun: 06:00-20:00\nFri-Sat: 06:00-21:00`,
    openingHours_es: `Lun-Jue, Dom: 06:00-20:00\nVie-Sáb: 06:00-21:00`,
    openingHours_fr: `Lun-Jeu, Dim: 06h00-20h00\nVen-Sam: 06h00-21h00`,
    openingHours_de: `Mo-Do, So: 06:00-20:00\nFr-Sa: 06:00-21:00`,
    discountInfo: "Serve cibo al bar e drink per l'happy hour. Cani ammessi.",
    discountInfo_en:
      "Serves food at the bar and happy hour drinks. Dogs allowed.",
    discountInfo_es:
      "Sirve comida en el bar y bebidas para el happy hour. Perros admitidos.",
    discountInfo_fr:
      "Sert de la nourriture au bar et des boissons pour l'happy hour. Chiens admis.",
    discountInfo_de:
      "Serviert Speisen an der Bar und Happy-Hour-Getränke. Hunde erlaubt.",
    tags: [
      "Bar",
      "Ristorante",
      "Cibo al Bar",
  ...
  },
  {
    ...
    openingHours: `Lun-Gio: 05:45-14:15, 15:45-19:30\nVen-Dom: 05:30-20:00`, // Updated for Fri-Sun
    openingHours_en: `Mon-Thu: 05:45-14:15, 15:45-19:30\nFri-Sun: 05:30-20:00`, // Updated
    openingHours_es: `Lun-Jue: 05:45-14:15, 15:45-19:30\nVie-Dom: 05:30-20:00`, // Updated
    openingHours_fr: `Lun-Jeu: 05h45-14h15, 15h45-19h30\nVen-Dim: 05h30-20h00`, // Updated
    openingHours_de: `Mo-Do: 05:45-14:15, 15:45-19:30\nFr-So: 05:30-20:00`, // Updated
  ...
  {
    id: 512, // Using a shop ID sequence
    name: "Porta Gialla - Emporio Alimentare (Adunata Special)",
    name_en: "Porta Gialla - Food Emporium (Adunata Special)",
    name_es: "Porta Gialla - Emporio Alimentario (Especial Adunata)",
    name_fr: "Porta Gialla - Emporium Alimentaire (Spécial Adunata)",
    name_de: "Porta Gialla - Lebensmittel-Emporium (Adunata Spezial)",
    type: "clothing", // Changed to 'clothing' for shop category
    coordinates: [45.56496, 8.051533], // Updated coordinates
    googleRating: 4.7,
    googleReviewCount: 20,
    address: "Via Giuseppe Arnulfo, 14, 13900 Biella BI",
    phone: "0150157160",
    website: "https://www.facebook.com/emporioleggero/", // Updated website
    shortDescription:
      "Porta Gialla Emporio: prodotti locali, menu speciali Alpini (panini, birra/vino). Orari super estesi Ven-Dom!",
    shortDescription_en:
      "Porta Gialla Emporium: local products, special Alpini menus (sandwiches, beer/wine). Super extended Fri-Sun hours!",
    shortDescription_es:
      "Porta Gialla Emporio: productos locales, menús especiales Alpini (bocadillos, cerveza/vino). ¡Horario súper extendido Vie-Dom!",
    shortDescription_fr:
      "Porta Gialla Emporium : produits locaux, menus spéciaux Alpins (sandwichs, bière/vin). Horaires super étendus Ven-Dim !",
    shortDescription_de:
      "Porta Gialla Emporium: lokale Produkte, spezielle Alpini-Menüs (Sandwiches, Bier/Wein). Super verlängerte Fr-So Öffnungszeiten!",
    details:
      "L'Emporio Alimentare Porta Gialla, in Via Arnulfo, è il vostro punto di riferimento per prodotti locali da mangiare e bere. Per l'Adunata, oltre alla consueta offerta di eccellenze del territorio, propone menu speciali a tema Alpino con panini gourmet accompagnati da birra o vino. Un'occasione per gustare e acquistare specialità locali. Approfittate degli orari super estesi nel weekend (Ven-Dom: 10:00-04:00) per una sosta golosa a qualsiasi ora.",
    details_en:
      "Porta Gialla Food Emporium, on Via Arnulfo, is your go-to for local food and drink products. For the Adunata, in addition to their usual offerings of regional excellences, they feature special Alpine-themed menus with gourmet sandwiches paired with beer or wine. An opportunity to taste and purchase local specialties. Take advantage of the super extended weekend hours (Fri-Sun: 10:00 AM - 04:00 AM) for a delicious stop at any time.",
    details_es:
      "El Emporio Alimentario Porta Gialla, en Via Arnulfo, es su punto de referencia para productos locales para comer y beber. Para la Adunata, además de su oferta habitual de excelencias de la región, proponen menús especiales temáticos Alpinos con bocadillos gourmet acompañados de cerveza o vino. Una oportunidad para degustar y comprar especialidades locales. Aproveche el horario súper extendido del fin de semana (Vie-Dom: 10:00-04:00) para una parada deliciosa a cualquier hora.",
    details_fr:
      "L'Emporium Alimentaire Porta Gialla, Via Arnulfo, est votre référence pour les produits locaux à manger et à boire. Pour l'Adunata, en plus de leur offre habituelle d'excellences régionales, ils proposent des menus spéciaux sur le thème Alpin avec des sandwichs gourmets accompagnés de bière ou de vin. Une occasion de déguster et d'acheter des spécialités locales. Profitez des horaires super étendus le week-end (Ven-Dim : 10h00-04h00) pour une halte gourmande à toute heure.",
    details_de:
      "Das Lebensmittel-Emporium Porta Gialla in der Via Arnulfo ist Ihr Anlaufpunkt für lokale Ess- und Trinkprodukte. Für die Adunata bieten sie zusätzlich zu ihrem üblichen Angebot an regionalen Köstlichkeiten spezielle Alpen-Themenmenüs mit Gourmet-Sandwiches, begleitet von Bier oder Wein. Eine Gelegenheit, lokale Spezialitäten zu probieren und zu kaufen. Nutzen Sie die super verlängerten Wochenendöffnungszeiten (Fr-So: 10:00-04:00 Uhr) für einen leckeren Stopp zu jeder Zeit.",
    images: ["/images/portaGialla.jpeg"],
    openingHours: `Mar-Gio: 09:00-12:30, 16:00-19:30\nVen-Dom: 10:00-04:00\nLun: Chiuso`,
    openingHours_en: `Tue-Thu: 09:00-12:30, 16:00-19:30\nFri-Sun: 10:00-04:00\nMon: Closed`,
    openingHours_es: `Mar-Jue: 09:00-12:30, 16:00-19:30\nVie-Dom: 10:00-04:00\nLun: Cerrado`,
    openingHours_fr: `Mar-Jeu: 09h00-12h30, 16h00-19h30\nVen-Dim: 10h00-04h00\nLun: Fermé`,
    openingHours_de: `Di-Do: 09:00-12:30, 16:00-19:30\nFr-So: 10:00-04:00\nMo: Geschlossen`,
    discountInfo:
      "Prodotti locali. Menu speciali Alpini con panini e birra/vino.",
    discountInfo_en:
      "Local products. Special Alpini menus with sandwiches and beer/wine.",
    discountInfo_es:
      "Productos locales. Menús especiales Alpini con bocadillos y cerveza/vino.",
    discountInfo_fr:
      "Produits locaux. Menus spéciaux Alpins avec sandwichs et bière/vin.",
    discountInfo_de:
      "Lokale Produkte. Spezielle Alpini-Menüs mit Sandwiches und Bier/Wein.",
    tags: [
      "Negozio",
      "Emporio Alimentare",
      "Prodotti Locali",
  ...
  {
    id: 513, // New unique ID
    name: "Bottega La Rosa (Gadget & Souvenir)",
    name_en: "Bottega La Rosa (Gadgets & Souvenirs)",
    name_es: "Bottega La Rosa (Artículos y Recuerdos)",
    name_fr: "Bottega La Rosa (Gadgets & Souvenirs)",
    name_de: "Bottega La Rosa (Gadgets & Souvenirs)",
    type: "clothing", // For general shops/gadgets
    coordinates: [45.561439, 8.04997],
    googleRating: 5.0,
    googleReviewCount: 1, // Note: High rating, very few reviews
    address: "Via Eugenio Bona, 4, 13900 Biella BI",
    phone: "3495019357",
    website: "https://www.instagram.com/bottegalarosa/?hl=it",
    shortDescription:
      "Bottega La Rosa a Biella: gadget artigianali, calamite e portachiavi di Biella. Ricordi speciali dell'Adunata!",
    shortDescription_en:
      "Bottega La Rosa in Biella: artisanal gadgets, Biella magnets and keychains. Special Adunata souvenirs!",
    shortDescription_es:
      "Bottega La Rosa en Biella: artículos artesanales, imanes y llaveros de Biella. ¡Recuerdos especiales de la Adunata!",
    shortDescription_fr:
      "Bottega La Rosa à Biella : gadgets artisanaux, magnets et porte-clés de Biella. Souvenirs spéciaux de l'Adunata !",
    shortDescription_de:
      "Bottega La Rosa in Biella: handgefertigte Gadgets, Biella-Magnete und Schlüsselanhänger. Besondere Adunata-Souvenirs!",
    details:
      "Bottega La Rosa, situata in Via Eugenio Bona a Biella, è il posto giusto per trovare un ricordo speciale dell'Adunata o un regalo originale. Offre una varietà di gadget artigianali di vario tipo e genere, incluse calamite e portachiavi che celebrano Biella. Perfetto per chi cerca un piccolo tesoro da portare a casa. Orari speciali nel weekend dell'Adunata (Ven-Dom: 10:00-19:00).",
    details_en:
      "Bottega La Rosa, located on Via Eugenio Bona in Biella, is the right place to find a special Adunata souvenir or an original gift. It offers a variety of artisanal gadgets of various types and kinds, including magnets and keychains celebrating Biella. Perfect for those looking for a little treasure to take home. Special hours on Adunata weekend (Fri-Sun: 10:00 AM - 7:00 PM).",
    details_es:
      "Bottega La Rosa, ubicada en Via Eugenio Bona en Biella, es el lugar adecuado para encontrar un recuerdo especial de la Adunata o un regalo original. Ofrece una variedad de artículos artesanales de diversos tipos y géneros, incluyendo imanes y llaveros que celebran Biella. Perfecto para quienes buscan un pequeño tesoro para llevar a casa. Horario especial el fin de semana de la Adunata (Vie-Dom: 10:00-19:00).",
    details_fr:
      "Bottega La Rosa, située Via Eugenio Bona à Biella, est l'endroit idéal pour trouver un souvenir spécial de l'Adunata ou un cadeau original. Elle propose une variété de gadgets artisanaux de différents types et genres, y compris des magnets et des porte-clés célébrant Biella. Parfait pour ceux qui cherchent un petit trésor à rapporter à la maison. Horaires spéciaux le week-end de l'Adunata (Ven-Dim : 10h00-19h00).",
    details_de:
      "Bottega La Rosa in der Via Eugenio Bona in Biella ist der richtige Ort, um ein besonderes Adunata-Souvenir oder ein originelles Geschenk zu finden. Es bietet eine Vielzahl von handgefertigten Gadgets verschiedener Arten und Gattungen, darunter Magnete und Schlüsselanhänger, die Biella feiern. Perfekt für diejenigen, die einen kleinen Schatz mit nach Hause nehmen möchten. Sonderöffnungszeiten am Adunata-Wochenende (Fr-So: 10:00-19:00 Uhr).",
    images: ["/images/bottegaLaRosa.jpeg"], // Suggested image path
    openingHours: `Lun, Mer: 09:00-13:00, 15:30-18:00\nMar, Gio: 09:30-18:00\nVen-Dom: 10:00-19:00`,
    openingHours_en: `Mon, Wed: 09:00-13:00, 15:30-18:00\nTue, Thu: 09:30-18:00\nFri-Sun: 10:00-19:00`,
    openingHours_es: `Lun, Mié: 09:00-13:00, 15:30-18:00\nMar, Jue: 09:30-18:00\nVie-Dom: 10:00-19:00`,
    openingHours_fr: `Lun, Mer: 09h00-13h00, 15h30-18h00\nMar, Jeu: 09h30-18h00\nVen-Dim: 10h00-19h00`,
    openingHours_de: `Mo, Mi: 09:00-13:00, 15:30-18:00\nDi, Do: 09:30-18:00\nFr-So: 10:00-19:00`,
    discountInfo: "Gadget artigianali, calamite e portachiavi di Biella.",
    discountInfo_en: "Artisanal gadgets, Biella magnets and keychains.",
    discountInfo_es: "Artículos artesanales, imanes y llaveros de Biella.",
    discountInfo_fr: "Gadgets artisanaux, magnets et porte-clés de Biella.",
    discountInfo_de:
      "Handgefertigte Gadgets, Biella-Magnete und Schlüsselanhänger.",
    tags: [
      "Negozio",
      "Gadget",
      "Souvenir",
